...
#---- Cleaning the text and graphing word frequency-------------------
...
#----Accessing and comparing word freq. data-------------------------

#we derive and compare word frequency data. We will do this first for 
...
# Here I will add a few more arguments to plot in order
...
#while sm???agol appears 143 times
...
#----Accessing and comparing word freq. data
# derive and compare word frequency data. 
...
#---- token distribution/dispersion plots
